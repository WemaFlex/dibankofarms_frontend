  ...
  return (
    <div className="w-full max-w-md mx-auto text-center">
      ...
      <div className="mb-8 flex flex-col items-center">
        <div className="w-14 h-14 align-self-start bg-[#5B8C51]/10 border border-[#5B8C51]/20 rounded-2xl flex items-center justify-center mb-5 shadow-sm">
          {/* Explicitly passing the color via style to override AntD defaults */}
          <SafetyCertificateFilled style={{ color: '#5B8C51' }} className="text-3xl" />
        </div>
        ...
        <Text className="text-[#5C6672] text-base font-medium mt-2 block">
          Enter the 6-digit code generated by your chosen authenticator app.
        </Text>
      </div>
      ...
      <Form
        ...
        requiredMark={false}
      >
        {/* Added a wrapper to force absolute centering of the OTP boxes */}
